...
declare namespace biblio = 'guidelines.biblio';

(:~ The location of the Zotero Bibliography, in this case the group library EthioStudies:)
declare variable $local:zotcollection := 'https://api.zotero.org/groups/358366/';
...
declare variable $local:bibliography := doc('/db/apps/guidelines/data/bibliography.xml');
...
(:     if the url is too long, add here and there              &#x200b;   and it will break there if needed  :)
            ...
            case element(tei:hi)
                ...
                <fo:inline
                   ...
                   default return
                             ...
                             case element(tei:exemplum)
                             return
        <fo:block>
            <fo:block font-style="italic">Example {count($node/preceding-sibling::tei:exemplum) +1}</fo:block>
           { fo:tei2fo($node/node())}
        </fo:block>
        
        case element(tei:content)
        return
        <fo:block>
            <fo:block font-size="larger">content</fo:block>
    ...
    case element(tei:classes)
    return
        <fo:block>
            <fo:block font-size="larger">classes</fo:block>
            <fo:block white-space="pre" font-size="smaller" margin-top="3mm" margin-bottom="3mm" line-height="11.5pt">
            {fo:tei2fo($node/node())}
            </fo:block>
        </fo:block>
        
    case element(tei:attList) 
    return
        <fo:block>
            <fo:block font-size="larger">classes</fo:block>
            {fo:tei2fo($node/node())}
        </fo:block>
        case element(tei:attDef)
        return
        <fo:block>
            <fo:block font-weight="bold">attribute 
                {string($node/@ident)}
           </fo:block>
            {if($node/tei:datatype) then 'This attribute can have a maximum of '|| string($node/tei:datatype/@maxOccurs )|| ' values separated by a space. ' else ()}
            {fo:tei2fo($node/node())}
        </fo:block>
        
        case element(tei:valList)
        return
      (  <fo:block>This is a <fo:inline font-style="italic">{string($node/@type)}</fo:inline>
             list of allowed values</fo:block>,
             <fo:table>
...
<fo:table-body>
  {fo:tei2fo($node/tei:valItem)}
</fo:table-body>)

</fo:table>
       
        )
    case element(tei:valItem)
    return
    <fo:table-row>
    <fo:table-cell>
      <fo:block>{string($node/@ident)}</fo:block>
    </fo:table-cell>
    <fo:table-cell>
      <fo:block>{fo:tei2fo($node/tei:desc)}</fo:block>
    </fo:table-cell>
  </fo:table-row>
       
        
    case element(tei:constraintSpec)
    return
    <fo:table>
...
<fo:table-header>
  <fo:table-row>
    ...
    <fo:table-cell>
      <fo:block font-weight="bold">rule</fo:block>
    </fo:table-cell>
    <fo:table-cell>
      <fo:block font-weight="bold">report</fo:block>
    </fo:table-cell>
  </fo:table-row>
</fo:table-header>

<fo:table-body>
       {for $c in $node/tei:constraint/sch:rule
       return
       <fo:table-row>
    <fo:table-cell>
      <fo:block >{string($c/@context)}</fo:block>
    </fo:table-cell>
    <fo:table-cell>
      {for $report in $c/sch:report return <fo:block >{string($report/@test)}</fo:block>}
    </fo:table-cell>
    <fo:table-cell>
      {for $report in $c/sch:report return <fo:block  >{$report/text()}</fo:block>}
    </fo:table-cell>
  </fo:table-row>
       }
...
(:                        This handles only the Glossary.xml list :)
                        ...
                        [{
                        let $references := (collection('/db/apps/guidelines/data/chapters')//tei:term[lower-case(text()) = lower-case($lab)], collection('/db/apps/guidelines/data/front')//tei:term[lower-case(text()) = lower-case($lab)])
...
<fo:block hyphenate="true" page-break-after="avoid">
    ...
    case element(tei:listBibl)
     ...
     else if($node/parent::tei:cit or $node/parent::tei:desc) 
     then (<fo:inline>{
            try{fo:zoteroCit($node/tei:ptr/@target)} 
            catch * {console:log($err:description)}}
            {if($node/tei:citedRange) then ', ' || (switch($node/tei:citedRange/@unit) 
...
<fo:page-sequence
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell>
                                <fo:block
                                    text-align="center"
                                    font-size="9pt"
                                    font-family="Ludolfus">Main Table of Contents</fo:block>
                            </fo:table-cell>
        ...
        <fo:flow
            ...
            <fo:block-container
                ...
                font-weight="700" 
                text-align="center" 
                display-align="center"><fo:block>Beta maṣāḥǝft Guidelines</fo:block>
            <fo:block
                font-size="12pt"
                space-before="25.2pt"
                space-after="12.24pt"
               ...
               { for $r in collection('/db/apps/guidelines/data/toc')//tei:TEI
                    return
                        <fo:block
                            ...
                            font-family="Ludolfus" 
                            margin-bottom="0.5cm">
                            <fo:inline>TOC {$r//tei:titleStmt/tei:title/text()}</fo:inline>
                            <fo:leader
                                leader-pattern="dots"/>
                            <fo:page-number-citation
                                ref-id="TOC{$r/text()}"/>
                         ...
                         <fo:block
                            ...
                            font-family="Ludolfus" 
                            margin-bottom="0.5cm">
                            <fo:inline>Beta maṣāḥǝft Schema</fo:inline>
                            <fo:leader
                                leader-pattern="dots"/>
                            <fo:page-number-citation
                                ref-id="BMSCHEMA"/>
            ...
            { for $r  in collection('/db/apps/guidelines/data/pages')//tei:TEI
            let $id := string($r//tei:body/@xml:id)
                  order by $id
                    return
                        <fo:block
                            text-align-last="justify"
...
<fo:block
                            ...
                            margin-top="0.5cm"
                            >
                            <fo:inline>ELEMENTS</fo:inline>
                            <fo:leader
                                leader-pattern="dots"/>
                            
                            
                        </fo:block>
             { for $r  in collection('/db/apps/guidelines/data/elements')//tei:TEI
              let $id := string($r//tei:body/@xml:id)
                  order by $id
                     return
                        <fo:block
...
,
for $toc in collection('/db/apps/guidelines/data/toc')
return
<fo:page-sequence
            initial-page-number="auto-odd"
        master-reference="Aethiopica-master" format="i">
         <fo:static-content
                flow-name="rest-region-before-even">
        <fo:table id="TOC{string($toc//tei:body/@xml:id)}">
                    <fo:table-column
                        column-width="30%"/>
                    <fo:table-column
                        column-width="40%"/>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell>
                                <fo:block
                                    text-align="center"
                                    font-size="9pt"
                                    font-family="Ludolfus">Table of Contents {$toc//tei:titleStmt/tei:title/text()}</fo:block>
                            </fo:table-cell>
                            <fo:table-cell><fo:block
                                    font-size="9pt"
                                    font-family="Ludolfus"
        ...
        <fo:flow
            ...
            <fo:block
                ...
                font-weight="700" 
                text-align="center" 
                display-align="center">Table of Contents {$toc//tei:titleStmt/tei:title/text()}</fo:block>
               { for $r in $toc//tei:item
               let $i := $r/text()
                    return
                        <fo:block
                            text-align-last="justify"
                            ...
                            font-family="Ludolfus" 
                            margin-bottom="0.5cm">
                            <fo:inline>{collection('/db/apps/guidelines/data')//id($i)/ancestor::tei:TEI//tei:titleStmt/tei:title/text()}</fo:inline>
                            <fo:leader
                                leader-pattern="dots"/>
                            <fo:page-number-citation
                                ref-id="{$r/text()}"/>
...
declare function fo:bookmarks() {
    <fo:bookmark-tree>
    { for $r in (doc('/db/apps/guidelines/data/front/acknowledgement.xml')//tei:TEI, doc('/db/apps/guidelines/data/front/intro.xml')//tei:TEI)
                    return
                    <fo:bookmark
      ...
      { for $r at $p in collection('/db/apps/guidelines/data/chapters')//tei:TEI 
      let $n := number(substring-after($r/@xml:id, 'chapter'))
            ...
            { for $r at $p in collection('/db/apps/guidelines/data/FAQ')//tei:TEI 
                    return
                     <fo:bookmark
                        internal-destination="{string($r/@xml:id)}{generate-id($r//tei:titleStmt/tei:title)}">
                        <fo:bookmark-title>{$r//tei:titleStmt/tei:title/text()}</fo:bookmark-title>
    ...
    <fo:page-sequence
        ...
        <fo:flow
            ...
            <fo:block
               ...
               { for $FC in collection('/db/apps/guidelines/data')//tei:figure
...
let $all := (collection('/db/apps/guidelines/data/chapters'), collection('/db/apps/guidelines/data/front'))
return
<fo:page-sequence
            initial-page-number="auto-odd"
...
declare function fo:main() {  
    <fo:root 
        ...
        <fo:page-sequence
            ...
            master-reference="Aethiopica-master">
            {attribute  initial-page-number{"auto-odd"}}
              <fo:static-content
                flow-name="rest-region-before-even">
        <fo:table>
                    <fo:table-column
        ...
        <fo:table>
            ...
            <fo:flow
                ...
                hyphenate="true">
                        ...
                        <fo:block-container id="{$id}">{fo:tei2fo($r/node())}</fo:block-container>
               <fo:block-container>
                {let $occurrences :=collection('/db/apps/guidelines/data')//tei:ref[@target = $id]
                return
                if (count($occurrences) lt 1) then <fo:block>No occurrences in the pages section.</fo:block> else
                (<fo:block>This page is referred to in the following pages</fo:block>,
<fo:list-block provisional-distance-between-starts="70pt" provisional-label-separation="3pt">
...
return
<fo:list-item margin-bottom="5pt"><fo:list-item-label end-indent="label-end()">
                        <fo:block font-weight="800" margin-right="5mm" hyphenate="false">
                         ...
                         <fo:list-item-body  start-indent="body-start()">
                        <fo:block hyphenate="true">{$name}</fo:block></fo:list-item-body></fo:list-item>
}
</fo:list-block>)
}
</fo:block-container>
{
for $change at $p in $r//tei:change
return

   <fo:block>{editors:editorKey($change/@who)} on {string($change/@when)}: {$change/text()}</fo:block>
        ...
        <fo:table>
            ...
            <fo:flow
                ...
                <fo:block-container id="{$id}">{fo:tei2fo($r/node())}</fo:block-container>
                <fo:block-container>
                <fo:block>TEI guidelines <fo:basic-link 
                external-destination="http://www.tei-c.org/release/doc/tei-p5-doc/en/html/ref-{$id}.html">element {$id}</fo:basic-link>
                </fo:block>
                 <fo:block>
                {if(doc('/db/apps/guidelines/schema/tei-betamesaheft.xml')//tei:elementSpec[@ident=$id]) then 
                (let $elemSpec := doc('/db/apps/guidelines/schema/tei-betamesaheft.xml')//tei:elementSpec[@ident=$id] return 
                fo:tei2fo($elemSpec) ) else ()}
                </fo:block>
                </fo:block-container>
                ...
                {let $occurrences :=collection('/db/apps/guidelines/data')//tei:gi[. = $id]
                return
                if (count($occurrences) lt 1) then <fo:block>No occurrences in the pages section.</fo:block> else
                (<fo:block>This element is referred to in the following pages</fo:block>,
for $occurrence in $occurrences
let $ref := $occurrence/ancestor::tei:body/@xml:id
group by $R := $ref
let $refFile := $col//id($R)
let $name := $refFile/ancestor::tei:TEI//tei:titleStmt/tei:title/text()
let $Rid :=  string($refFile/@xml:id)
return
if($Rid = ' ' or $Rid = '') then () else

                        <fo:block hyphenate="true">{$name}</fo:block>
)
}
</fo:block-container>
<fo:block-container margin-top="1cm">
<fo:block font-size="larger" margin-top="1cm">Changes</fo:block>
{
for $change at $p in $r//tei:change
return
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell>
                                <fo:block
                                    text-align="center"
                                    font-size="9pt"
                                    font-family="Ludolfus">Schema</fo:block>
                            </fo:table-cell>
                            <fo:table-cell><fo:block
                                    font-size="9pt"
                                    font-family="Ludolfus"
        ...
        <fo:table>
            ...
            <fo:flow
                ...
                hyphenate="true">
                        ...
                        <fo:block-container id="BMSCHEMA">
{for $eleSpec in doc('/db/apps/guidelines/schema/tei-betamesaheft.xml')//tei:elementSpec
let $i := string($eleSpec/@ident)
order by $i
return 
<fo:block margin-top="1cm"  margin-bottom="1cm" >
<fo:block><fo:basic-link font-size="larger" font-weight="bold"
external-destination="http://betamasaheft.eu/Guidelines/?id={$i}">{$i}</fo:basic-link></fo:block>
<fo:block>Mode : {string($eleSpec/@mode)}</fo:block>
<fo:block>Module : {string($eleSpec/@module)}</fo:block>
{
fo:tei2fo($eleSpec)
}</fo:block>
}
...
for $change at $p in doc('/db/apps/guidelines/schema/tei-betamesaheft.xml')//tei:change
return
...
return
    response:stream-binary($pdf, "media-type=application/pdf", "BMGL.pdf")
