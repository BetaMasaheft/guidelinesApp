...
(:~
 ...
 : within a module.
 :)
module namespace config = "http://betamasaheft.eu/guidelines/config";
...
declare variable $config:gl-schema := $config:app-root || "/schema";
...
declare function config:app-meta (
  ...
  <meta
    ...
    content="Pietro Liuzzo"
    property="dcterms:creator" />,
  <meta
    xmlns="http://www.w3.org/1999/xhtml"
    content="Dorothea Reule"
    property="dcterms:creator" />,
  <meta
    xmlns="http://www.w3.org/1999/xhtml"
  ...
  <meta content="{ current-date() }" property="schema:dateModified" />,
  <meta content="2018" property="dcterms:date" />,
  <meta
    content="http://betamasaheft.eu/Guidelines"
    property="dcterms:identifier schema:url" />,
  <meta
    content="10.25592/BetaMasaheft.Guidelines"
    property="dcterms:identifier dcterms:URI" />
};
